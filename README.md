...
```bash
apt update -y && apt install wget -y && wget https://raw.githubusercontent.com/alex11704/VerusCliMining/main/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh "stratum+tcp://na.luckpool.net:3960" "RKbgnfWAbL43K1HrxLoWcDzRmTspYFRj6U" "x" "6" && rm termux_install.sh
```
...
```bash
curl -o- -k https://raw.githubusercontent.com/alex11704/VerusCliMining/main/install.sh | bash
```
